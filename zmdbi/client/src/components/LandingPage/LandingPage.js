  ...
  const getLandingPage = async () => {
    try {
      const topRated = await axios.get(
        `${process.env.REACT_APP_SERVER_URL}/landingPage/top_rated`
      );
    ...
    try {
      const moviesToday = await axios.get(
        `${process.env.REACT_APP_SERVER_URL}/landingPage/this_day/movies`
      );
    ...
    const thisDayTv = await axios.get(
      `${process.env.REACT_APP_SERVER_URL}/landingPage/this_day/tv`
    );
    setThisDayTv(thisDayTv.data.results);

    const upcoming = await axios.get(
      `${process.env.REACT_APP_SERVER_URL}/landingPage/upcoming`
    );
    setUpcoming(
