        ...
        <Grid item sm={3}>
          ...
          <Typography>
            {actorDetails.birthday ? (
              <div>
                {actorDetails.birthday} (
                {Number(currentYear - actorDetails.birthday.slice(0, 4))} years
                old)
              </div>
            ) : (
              "-"
        ...
        <Grid item sm={9} style={{ paddingLeft: "20px" }}>
          <div>
            ...
            <Typography variant="body1" style={{ marginBottom: "15px" }}>
              {actorDetails.biography ? actorDetails.biography : "No biography"}
            </Typography>
          </div>
            ...
            {creditsSortedByPopularity.map((credit) => (
              ...
              >
                ...
                >
                  ...
                  <Typography className="hoverLink">{credit.title}</Typography>
                </Link>
              </div>
            ))}
          </div>
